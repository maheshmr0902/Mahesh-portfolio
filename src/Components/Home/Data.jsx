...
const Data = () => {
  return (
    <div className='home-data'>
        <h1 className='home-title'> Mahesh Nunnaboyina
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home-subtitle"> Mern Stack Dveloper</h3>
        <p className='home-description'>I'm Nunnaboyina Mahesh, a passionate MERN Stack Developer with an MCA degree. I love building full-stack web applications that are fast, responsive, and user-friendly. I'm always eager to learn and grow as a developer.</p>
